...
Lidarr, SABnzbd and Radarr4k are available through self installation (Custom Containers [Wiki here on GitHub](https://github.com/TechPerplexed/Gooby/wiki/Custom-Containers "Custom Containers").
